    ...
    def get_data(self):
        ...
        for task_path in all_tasks:
            ...
            for frame in range(self.cfg.hist_frame_nums, total_frames - self.cfg.future_frame_nums):
                ...
                # depth
                self.front_depth.append(task_path + "/depth_e2e_front/" + filename)
                self.left_depth.append(task_path + "/depth_e2e_left/" + filename)
                self.right_depth.append(task_path + "/depth_e2e_right/" + filename)
                self.rear_depth.append(task_path + "/depth_e2e_rear/" + filename)
