...
class CarlaDataset(torch.utils.data.Dataset):
    ...
    def get_data(self):
        ...
        for task_path in all_tasks:
            ...
            for frame in range(self.cfg.hist_frame_nums, total_frames - self.cfg.future_frame_nums):
                ...
                self.velocity_x.append(speed_ego.x)
                self.velocity_y.append(speed_ego.y)
                self.velocity_z.append(speed_ego.z)
    ...
    def __getitem__(self, index):
        ...
        ego_motion = np.column_stack((self.velocity_x[index], self.velocity_y[index], self.velocity_z[index], self.acc_x[index], self.acc_y[index]))
