...
from trainer.pl_processor import ParkingProcessingModule, setup_callbacks
from pytorch_lightning.loggers import TensorBoardLogger

from dataset.dataloader_process import ParkingDataModule
...
def process():
    ...
    parking_model = ParkingProcessingModule(cfg)
