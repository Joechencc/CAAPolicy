...
class ParkingTrainingModule(pl.LightningModule):
    ...
    def training_step(self, batch, batch_idx):
        loss_dict = {}
        pred_control, pred_dynamics, pred_segmentation, pred_depth = self.parking_model(batch)
        ...
        dynamics_loss = self.dynamics_loss_func(pred_dynamics, batch)
        loss_dict.update({
            "dynamics_val_loss": dynamics_loss
        })
    ...
    def validation_step(self, batch, batch_idx):
        ...
        dynamics_val_loss = self.dynamics_loss_func(pred_dynamics, batch)
        val_loss_dict.update({
            "dynamics_val_loss": dynamics_val_loss
        })
