...
def get_cfg(cfg_yaml: dict):
    ...
    cfg.direct_nums = config['direct_nums']
    ...
    cfg.OccNet_cfg['occ_encoder_backbone_cfg']['norm_cfg'] = dict(type='GN', num_groups=8, requires_grad=True)
    cfg.OccNet_cfg['occ_encoder_neck_cfg']['norm_cfg'] = dict(type='GN', num_groups=8, requires_grad=True)
