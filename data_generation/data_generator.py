...
from data_generation.generate_video import images_to_video
from data_generation.tools import encode_npy_to_pil
from data_generation.world import World
from tool.ply2voxel import align_from_path_save
...
class DataGenerator:
    def __init__(self, carla_world, args):
        ...
        with open('./config/sensor_setup.yaml', 'r') as file:
            ...
            self.cam_specs = data['cam_specs']
            self.lidar_specs = data['lidar_specs']
    ...
    def save_unit_data(self, start, end, cur_save_path):
        for index in range(start, end):
            ...
            for sensor in data_frame.keys():
                if sensor.startswith('camera') or sensor.startswith('rgb'):
