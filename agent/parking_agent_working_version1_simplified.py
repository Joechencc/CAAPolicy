...
import time, sys
####################################################################################
####### replace the following paths where you installed your carla environment 
...
import math
############ You can place the hybrid A star cython file under the folder agent/Fast_hybrid_A_star 
import agent.Fast_hybrid_A_star.hybrid_A_star as hybrid_a_star
import matplotlib.pyplot as plt
from scipy.spatial.transform import Rotation as Rot
#import agent.Fast_hybrid_A_star.draw as draw ## not needed if you do not want to visualize the path
from functools import reduce
import open3d as o3d #### for lidar point clouds
from matplotlib import cm

#from controller.controller import VehiclePIDController  ###not needed when we assign the next position
